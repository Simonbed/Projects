...
db = pd.read_excel("Processus gestion de commandes clients  (Copie) 1.xlsx")
...
"Info Client" , "Info Utilisateur Interne",
"Info livreur", "Info Fournisseur",
...
"Activité complétant le processus gestion commande",
